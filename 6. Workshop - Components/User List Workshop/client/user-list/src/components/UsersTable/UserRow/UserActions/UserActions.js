...
const UserActions = ({ id, onDetailsClick }) => {
  ...
  return (
    <td className="actions">
      <ActionButton
        btnClass={"btn edit-btn"}
        btnTitle={"Edit"}
        dataIcon={"pen-to-square"}
        iconClasses={"svg-inline--fa fa-pen-to-square"}
        viewBox={"0 0 532 512"}
        d={
      ...
      <ActionButton
        btnClass={"btn delete-btn"}
        btnTitle={"Delete"}
        dataIcon={"trash"}
        iconClasses={"svg-inline--fa fa-trash"}
        viewBox={"0 0 498 512"}
        d={
      ...
      <ActionButton
        btnClass={"btn info-btn"}
        btnTitle={"Info"}
        dataIcon={"info"}
        iconClasses={"svg-inline--fa fa-info"}
